...
if (!defined('FILE_CACHE_DIRECTORY'))
	define('FILE_CACHE_DIRECTORY', './timthumb_cache');    // Directory where images are cached. Left blank it will use the system temporary directory (which is better for security)
...
if (!defined('DEFAULT_ZC'))
	define('DEFAULT_ZC', 2);	   // Default zoom/crop setting. Allows overrid in timthumb-config.php
...
if (!defined('WEBSHOT_XVFB_RUNNING'))
    ...
    include_once 'config/sysvars.php';
define('LOCAL_FILE_BASE_DIRECTORY', REALPATH);
...
class timthumb {
	...
	protected $cacheDirectory = 'timthumb_cache';
