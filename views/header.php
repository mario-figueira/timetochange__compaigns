...
?>
			<div class="nav">
				<ul>
					<li><a class="<?php echo $dashboard_classes;?>" href="<?php echo BASEPATH .'dashboard/show/selected_menu/'. menus_items_enum::$C_DASHBOARD; ?>" title="Dashboard"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="Dashboard" class="icoDashboard"></a></li>
					<li><a class="<?php echo $campaigns_mgnt_classes;?>" href="<?php echo BASEPATH .'campaigns_mgnt/show/selected_menu/'. menus_items_enum::$C_CAMPAIGNS_MGNT; ?>" title="Campaign Management"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="Campaign Management" class="icoDatabase"></a></li>   
					<li><a class="<?php echo $explorer_classes;?>" href="#" title="File Explorer"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="File Explorer" class="icoShoebox"></a></li>    
					<li><a class="<?php echo $settings_classes;?>" href="#" title="Settings"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="Settings" class="icoGear"></a></li>
					<li><a class="<?php echo $profile_classes;?>" href="#" title="Profile"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="Profile" class="icoUser"></a></li>
					<li><a class="<?php echo $logout_classes;?>" href="#" title="Logout"><img src="<?php echo $transparent_img_url; ?>" width="1" height="1" alt="Logout" class="icoCirclex"></a></li>
				</ul>
