...
class account_aliasesAction extends baseAction {
	...
	public function execute($a_command){
		...
		$account_aliases = $accounts_repo->alias_of_account__get_by_account($account);
		
		$a_command->set_parameter("account", $account);
		$a_command->set_parameter("account_aliases", $account_aliases);
